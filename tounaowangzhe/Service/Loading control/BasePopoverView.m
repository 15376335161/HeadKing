...
+ (MBProgressHUD *)showHUDToWindow:(BOOL)animated withMessage:(NSString *)message
{
    ...
    return [BasePopoverView showHUDAddedTo:window animated:animated withMessage:message];
}
...
+ (BOOL)hideHUDForWindow:(BOOL)animated
{
    ...
    return [BasePopoverView hideHUDForView:window animated:animated];
}
