...
//设置有圆角和阴影的View
+ (void)setShadowAndornerView:(UIView *)view {
    CALayer *sublayer =[CALayer layer];
    //    view.layer.shadowOffset = CGSizeMake(0, 1);
    view.layer.shadowRadius = 8.0;
    view.layer.shadowColor = DefaultColor.CGColor;
...
+ (void)showNoNetWorkImageView:(NSString *)imageName showViewController:(UIView *)VC {
    UIImageView *imageView = [[UIImageView alloc] initWithImage:IMAGE_NAME(imageName)];
    imageView.center = kUIWindow.center;
