...
//    fromVC.view.hidden = YES;
    ...
    kUIWindow.backgroundColor = [UIColor blackColor];
    ...
    toVC.view.frame = CGRectMake(0, containerView.frame.size.height, containerView.frame.size.width, kScreenHeight);
    //开始动画吧，使用产生弹簧效果的动画API
    
    [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
        //首先我们让vc2向上移动
        
        toVC.view.transform = CGAffineTransformMakeTranslation(0, -kScreenHeight);
...
//    [UIView animateWithDuration:[self transitionDuration:transitionContext] delay:0 usingSpringWithDamping:0 initialSpringVelocity:0 options:0 animations:^{
//        //首先我们让vc2向上移动
//
//        toVC.view.transform = CGAffineTransformMakeTranslation(0, -kScreenHeight);
//
